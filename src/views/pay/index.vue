<template>
  <div class="pay">
    ...
    <div class="address">
      ...
      <div class="info" v-if="selAddress?.address_id">
...
<script>
import { getAddressList } from '@/api/adress'
...
export default {
  ...
  computed: {
    ...
    // 住址信息
    localAddress () {
      const local = this.selAddress.region
      return local.province + local.city + local.region
    },
    // 返回的路由查询参数
    mode () {
